...
![Alt text](public/tabs/docs/IMG_001.png)
...
<p align="center"><img src="public/tabs/docs/IMG_02.png" alt="Alt text" width="60%" /></p>
...
<p align="center"><img src="public/tabs/docs/IMG_03.png" alt="Alt text" width="60%" /></p>
...
The method generates seed entropy using physical randomness from dice rolls and coin flips, which are mapped to BIP-39 words using a predefined table. The predefined table can be found [here](public/tabs/docs/DiceRoll_CoinFlip_LookupTable.pdf). This process determines the first words (n-1) of the seed phrase, while the final word is calculated as the checksum.

<p align="center"><img src="public/tabs/docs/IMG_04.png" alt="Alt text" width="60%" /></p>
...
<p align="center"><img src="public/tabs/docs/IMG_05.png" alt="Alt text" width="60%" /></p>

### Connect wallet

Connect a newly created wallet or any other wallet to Metamask or Rabby as a hardware wallet. 

<p align="center"><img src="public/tabs/docs/IMG_06.png" alt="Alt text" width="60%" /></p>
...
<p align="center"><img src="public/tabs/docs/IMG_07.png" alt="Alt text" width="60%" /></p>

Scan the generated UR:CRYPTO-HDKEY QR code with Metamask or Rabby to connect the wallet.

<p align="center"><img src="public/tabs/docs/IMG_08.png" alt="Alt text" width="85%" /></p>
...
<p align="center"><img src="public/tabs/docs/IMG_09.png" alt="Alt text" width="85%" /></p>
...
<p align="center"><img src="public/tabs/docs/IMG_10.png" alt="Alt text" width="60%" /></p>
...
<p align="center"><img src="public/tabs/docs/IMG_11.png" alt="Alt text" width="60%" /></p>
...
<p align="center"><img src="public/tabs/docs/IMG_12.png" alt="Alt text" width="60%" /></p>
